class Webdown < Formula
  ...
  resource "beautifulsoup4" do
    url "https://pypi.org/packages/source/b/beautifulsoup4/beautifulsoup4-4.13.3.tar.gz"
    sha256 "1bd32405dacc920b42b83ba01644747ed77456a65760e285fbc47633ceddaf8b"
  end

  resource "html2text" do
    url "https://pypi.org/packages/source/h/html2text/html2text-2024.2.26.tar.gz"
    sha256 "05f8e367d15aaabc96415376776cdd11afd5127a77fce6e36afc60c563ca2c32"
  end

  resource "requests" do
    url "https://pypi.org/packages/source/r/requests/requests-2.32.3.tar.gz"
  ...
  resource "soupsieve" do
    url "https://pypi.org/packages/source/s/soupsieve/soupsieve-2.5.tar.gz"
    sha256 "5663d5a7b3bfaeee0bc4372e7fc48f9cff4940b3eec54a6451cc5299f1097690"
  end

  resource "charset-normalizer" do
    url "https://pypi.org/packages/source/c/charset-normalizer/charset-normalizer-3.3.2.tar.gz"
    sha256 "f30c3cb33b24454a82faecaf01b19c18562b1e89558fb6c56de4d9118a032fd5"
  end

  resource "certifi" do
    url "https://pypi.org/packages/source/c/certifi/certifi-2024.2.2.tar.gz"
    sha256 "0569859f95fc761b18b45ef421b1290a0f65f147e92a1e5eb3e635f9a5e4e66f"
  end

  resource "idna" do
    url "https://pypi.org/packages/source/i/idna/idna-3.6.tar.gz"
    sha256 "9ecdbbd083b06798ae1e86adcbfe8ab1479cf864e4ee30fe4e46a003d12491ca"
  end

  resource "urllib3" do
    url "https://pypi.org/packages/source/u/urllib3/urllib3-1.26.18.tar.gz"
